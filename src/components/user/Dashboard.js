...
class Dashboard extends Component {
    render(){
        ...
        var goal = Math.ceil((.25 * 10 ** Math.ceil(Math.log10(this.props.user_data.hours+1)))*Math.ceil((this.props.user_data.hours+1)/(.25 * 10 ** Math.ceil(Math.log10(this.props.user_data.hours+1)))))
        return (
            <div>
                <div className="row">
                    <div className="col s12 xl8 offset-xl2">
                        ...
                        <div className="progress">    
                            <div className="determinate teal" style={{width: this.props.user_data.hours/goal*100 + "%"}}></div>
                        </div>
                    </div>
                </div>
                <div className="row">
                    ...
                    <div className="col s12 xl4">
                        ...
                        <div className="card-panel flex-container">
                            <h5 className="teal-text space-between">Volunteer as a peer tutor<a className="waves-effect waves-light btn-large teal" href="/volunteer"><i className="material-icons">trending_up</i></a></h5>
                        </div>
                    </div>
                </div>
            </div>
